...
document.addEventListener('DOMContentLoaded', async() => {
    ...
    if (sessionData && sessionData.caja_id) {
        ...
        console.warn("Sin caja asignada.");
    }
    ...
    // Filtros (IDs deben coincidir con egresos.html)
    const filtros = {
        fechaInicio: document.getElementById("fecha-inicio"),
        fechaFin: document.getElementById("fecha-fin"),
        id: document.getElementById("id-egreso"),
        cliente: document.getElementById("cliente"),
        tipoEgreso: document.getElementById("tipo-egreso"), // Asegúrate que el ID sea este en el HTML
    ...
    function obtenerEgresos() {
        ...
        fetch(`https://cambiosorion.cl/data/egr-caja.php?${params.toString()}`)
            ...
            .catch(err => {
                tablaEgresos.innerHTML = `<tr><td colspan="8" class="text-center py-4 text-red-500">${err.message}</td></tr>`;
            });
    }
