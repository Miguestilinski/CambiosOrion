document.addEventListener("DOMContentLoaded", () => {
    ...
    if (exportarBtn) {
        exportarBtn.addEventListener("click", () => {
            window.location.href = "exportar_inventarios_excel.php";
        });
    }

    function cargarDivisas() {
        fetch("inventarios.php?action=divisas")
            .then(res => res.json())
            .then(data => {
    ...
    function cargarInventarios() {
        ...
        fetch(`inventarios.php?action=listar&${params.toString()}`)
            .then(res => res.json())
            .then(inventarios => {
                ...
                inventarios.forEach(inv => {
                    ...
                    btnMostrar.addEventListener("click", () => {
                        window.location.href = `detalle-inventario.php?id=${inv.id}`;
                    });
